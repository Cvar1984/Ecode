...
style="height: 83px;" class="input100"
name="code" placeholder="Your
Script"></textarea>
					<span class="focus-input100"></span>
				</div>
<center>
	<select class='select2-selection--single' size="1"
name="ope">
	<option value="urlencode">url</option>
	<option value="base64">Base64</option>
	<option value="ur">base64 - convert_uu</option>
	<option value="gzinflates">gzinflate -
base64</option>
	<option value="str2">str_rot13 - base64</option>
	<option value="gzinflate">str_rot13 - gzinflate -
base64</option>
	<option value="str">str_rot13 - gzinflate - str_rot13 -
base64</option>
	<option value="url">base64 - gzinflate - str_rot13 -
convert_uu - gzinflate - base64</option>
</select>
<br>
...
break;default:break;}}
echo "<textarea style='height:83px;' cols='80'
rows='10' class='input100'
readonly>{$codi}</textarea>";
?>
</body>
</html>
